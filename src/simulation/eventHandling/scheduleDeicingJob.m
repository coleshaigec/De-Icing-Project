function simContext = scheduleDeicingJob(simContext, aircraftID, startTime, serverIndex)
    ...
    % -- Use aircraft's Gamma distribution parameters to sample service time --
