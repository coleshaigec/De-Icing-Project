...
def main() -> None:
    ...
    summary = (
        ...
        .agg(meanTotalOperatingCost=("totalOperatingCost", "mean"))
    ...
    ax.set_ylabel("Mean annual operating cost")
    ax.set_title(r"Operating cost vs. arrival concentration ($e=3$)")
    ax.grid(True)
    ...
    save_figure(fig, resolve_output_directory(args.out_dir), "cost_vs_sigma_lambda")
